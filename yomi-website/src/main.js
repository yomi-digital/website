...
const messages = {
  en: {
    message: {
      ...
      theHubContent: 'Masternode hosting platform of NFT minting and virtual staking boxes with a unique system at international level.',
      ...
      ambassadorContent: 'Platform that uses blockchain and token payment systems to reward ambassadors in social campaigns.',
  ...
  it: {
    message: {
      ...
      ambassadorContent: 'Piattaforma che utilizza la blockchain e il sistema di pagamento in token per ricompensare gli ambassador nelle campagne social.',
