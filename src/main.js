...
const messages = {
    en: {
        ...
        message: {
            ...
            umiContent: 'Is a first NFT API interface that allows you to create, manage and sell non-fungible tokens on different blockchains. The platform allows our customers like',
            umiContent2: 'to manage the complexities of the blockchain in full autonomy.',
    ...
    it: {
        ...
        message: {
            ...
            umiContent: 'È un interfaccia API first NFT che permette di creare, gestire e vendere token non fungibili su diverse blockchain. La piattaforma consente ai loro clienti come',
