...
const messages = {
    en: {
        message: {
            ...
            umiContent: 'Is a first NFT API interface that allows you to create, manage and sell non-fungible tokens on different blockchains. The platform allows their customers like Stargraph, Impssbl, Hexarchia to manage the complexities of the blockchain in full autonomy.',
