			...
			<tbody>
				...
				if (count($row_rs_all) > 0) {
					foreach ($row_rs_all as $row) { ?>
						<tr>
							<?php
							$customFields['permalink'] = $row['permalink'];
							$customFields['ref_page'] = $row['ref_page'];
							...
							<td style="text-align:center; width:60px">
								<a href="/bmt/<?php echo $route; ?>/<?php echo $row['id']; ?>/modifica" class="bmt-small-button"><i class="fa fa-edit"></i></a>
							</td>
						</tr>
				<?php }
				}
