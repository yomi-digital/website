				...
				<?php 
					$customFields['permalink']='
						<div class="control-group">
							...
							<div class="controls">
								<input required id="permalink" onkeydown="isWriting()" onkeyup="notWriting(\'permalink\')" type="text" name="permalink" class="form-control formInput">
					...
					while ($filename = readdir($dh)){
						if (is_file($dir."/".$filename)){
							if($filename!='.DS_Store'){
								$customFields['ref_page'].='<option value="'.$filename.'">'.$filename.'</option>';
							}
						}
					} 
